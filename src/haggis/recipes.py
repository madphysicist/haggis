...
__all__ = [
    'all_combinations', 'all_nsc', 'any_nsc', 'consume', 'dict_merge',
    'dict_select', 'grouper', 'immutable', 'islast', 'is_ordered_subset',
    'lenumerate', 'mapping_context', 'option_lookup', 'shift_left',
    'KeyedSingleton', 'RecursiveDict', 'Namespace',
]
...
class _NamespaceOverrideContext(mapping_context):
    """
    An extension of :py:class:`mapping_context` that is tailored for
    :py:class:`Namespace`.

    This class is designed specifically for :meth:`Namespace.override`.
    """
    __slots__ = ()
    ...
    def __init__(self, namespace, **kwargs):
        """
        Initialize a new context manager to replace the
        specified elements of the given namespace.
        """
    ...
    def getfunc(self, key):
        """
        Mapping getter customized for :py:class:`Namespace`
        instead of regular :py:class:`dict`.
        """
        return getattr(self.mapping, key, self.sentinel)

    def setfunc(self, key, value):
        """
        Mapping setter and deleter customized for
        :py:class:`Namespace` instead of regular
        :py:class:`dict`.
        """
        if value is self.sentinel:
...
class Namespace:
    ...
    This class is based heavily on :py:class:`argparse.Namespace`.
    """
